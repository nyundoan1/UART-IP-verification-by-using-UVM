class interrupt_rx_full_test extends uart_base_test;
     `uvm_component_utils(interrupt_rx_full_test)

     uart_configuration uart_config;
     uart_data_sequence uart_data_seq;

     function new(string name = "interrupt_rx_full_test", uvm_component parent);
     ...
     virtual task run_phase(uvm_phase phase);
          ...
          phase.raise_objection(this);
               ...
               regmodel.IER.write(status, 5'b0_0100);
               ...
               if (~rdata[2])
                    `uvm_error(get_type_name(), $sformatf("Interrupt rx fifo full is not assert"))
          #10ms;
          phase.drop_objection(this);
     endtask:run_phase

endclass: interrupt_rx_full_test
