class mode_13_rx_test extends uart_base_test;
     `uvm_component_utils(mode_13_rx_test)

     uart_configuration uart_config;
     uart_data_sequence  uart_data_seq;

     function new(string name = "mode_13_rx_test", uvm_component parent);
     ...
     virtual task run_phase(uvm_phase phase);
          ...
          //@(uart_env.uart_agt.uart_drv.drive_done);
          #5ms;
