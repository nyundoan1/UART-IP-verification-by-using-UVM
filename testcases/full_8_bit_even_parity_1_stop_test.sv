class full_8_bit_even_parity_1_stop_test extends uart_base_test;
     `uvm_component_utils(full_8_bit_even_parity_1_stop_test)

     uart_configuration uart_config;
     uart_data_sequence uart_data_seq;

     function new(string name = "full_8_bit_even_parity_1_stop_test", uvm_component parent);
     ...
     virtual task run_phase(uvm_phase phase);
          ...
          phase.raise_objection(this);
               ...
               regmodel.LCR.write(status, 32'h3B);
...
endclass: full_8_bit_even_parity_1_stop_test
