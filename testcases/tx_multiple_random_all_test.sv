class tx_multiple_random_all_test extends uart_base_test;
     `uvm_component_utils(tx_multiple_random_all_test)

     uart_configuration uart_config;

     function new(string name = "tx_multiple_random_all_test", uvm_component parent);
...
endclass: tx_multiple_random_all_test
