class rx_8_bit_even_parity_2_stop_test extends uart_base_test;
     `uvm_component_utils(rx_8_bit_even_parity_2_stop_test)
...
endclass:rx_8_bit_even_parity_2_stop_test 
