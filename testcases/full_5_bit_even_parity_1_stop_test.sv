class full_5_bit_even_parity_1_stop_test extends uart_base_test;
     `uvm_component_utils(full_5_bit_even_parity_1_stop_test)

     uart_configuration uart_config;
     uart_data_sequence uart_data_seq;

     function new(string name = "full_5_bit_even_parity_1_stop_test", uvm_component parent);
...
endclass: full_5_bit_even_parity_1_stop_test
