class full_multiple_random_all_test extends uart_base_test;
     `uvm_component_utils(full_multiple_random_all_test)

     uart_configuration uart_config;
     uart_data_sequence uart_data_seq;

     function new(string name = "full_multiple_random_all_test", uvm_component parent);
...
endclass: full_multiple_random_all_test
