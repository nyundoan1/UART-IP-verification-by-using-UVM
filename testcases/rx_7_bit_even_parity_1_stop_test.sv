class rx_7_bit_even_parity_1_stop_test extends uart_base_test;
     `uvm_component_utils(rx_7_bit_even_parity_1_stop_test)
...
endclass:rx_7_bit_even_parity_1_stop_test 
