class tx_5_bit_even_parity_2_stop_test extends uart_base_test;
     `uvm_component_utils(tx_5_bit_even_parity_2_stop_test)

     uart_configuration uart_config;

     function new(string name = "tx_5_bit_even_parity_2_stop_test", uvm_component parent);
     ...
     virtual task run_phase(uvm_phase phase);
          ...
          phase.raise_objection(this);
               ...
               regmodel.LCR.write(status, 32'h3C);
...
endclass: tx_5_bit_even_parity_2_stop_test
