class full_6_bit_even_parity_2_stop_test extends uart_base_test;
     `uvm_component_utils(full_6_bit_even_parity_2_stop_test)

     uart_configuration uart_config;
     uart_data_sequence uart_data_seq;

     function new(string name = "full_6_bit_even_parity_2_stop_test", uvm_component parent);
     ...
     virtual task run_phase(uvm_phase phase);
          ...
          phase.raise_objection(this);
               ...
               regmodel.LCR.write(status, 32'h3D);
...
endclass: full_6_bit_even_parity_2_stop_test
