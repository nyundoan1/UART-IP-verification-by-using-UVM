class tx_6_bit_no_parity_2_stop_test extends uart_base_test;
     `uvm_component_utils(tx_6_bit_no_parity_2_stop_test)

     uart_configuration uart_config;

     function new(string name = "tx_6_bit_no_parity_2_stop_test", uvm_component parent);
...
endclass: tx_6_bit_no_parity_2_stop_test
