class rx_6_bit_even_parity_1_stop_test extends uart_base_test;
     `uvm_component_utils(rx_6_bit_even_parity_1_stop_test)
...
endclass:rx_6_bit_even_parity_1_stop_test 
