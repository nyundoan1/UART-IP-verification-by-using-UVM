class mode_16_rx_test extends uart_base_test;
     `uvm_component_utils(mode_16_rx_test)

     uart_configuration uart_config;
     uart_data_sequence  uart_data_seq;

     function new(string name = "mode_16_rx_test", uvm_component parent);
