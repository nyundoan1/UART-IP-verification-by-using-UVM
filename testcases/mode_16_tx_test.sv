class mode_16_tx_test extends uart_base_test;
     `uvm_component_utils(mode_16_tx_test)

     uart_configuration uart_config;

     function new(string name = "mode_16_tx_test", uvm_component parent);
